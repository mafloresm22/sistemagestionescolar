...
return [
    ...
    */
    ...
    'logo' => '<span style="display: inline-block; line-height: 1.2; vertical-align: middle; margin-left: 10px; text-align: left;">
                <b style="font-size: 10px; display: block; opacity: 0.8; text-transform: uppercase; letter-spacing: 1px; color: #f8f9fa;">I.E. PUBLICA</b>
                <span style="font-size: 14px; font-weight: 800; letter-spacing: -0.3px; color: #ffffff;">Antenor Orrego Espinoza</span>
              </span>',
    'logo_img' => 'vendor/adminlte/dist/img/IEAOE.jpg',
    'logo_img_class' => 'brand-image img-circle elevation-3 border border-white',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Logo I.E. Antenor Orrego Espinoza',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/IEAOE.jpg',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'usermenu_header_class' => 'bg-primary-custom shadow-sm',
    'usermenu_image' => true,
    'usermenu_desc' => true,
    ...
    */
    ...
    'classes_content' => '',
    'classes_sidebar' => 'sidebar-dark-primary elevation-4 sidebar-custom-color',
    'classes_sidebar_nav' => '',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'icon'    => 'fas fa-book',
            'classes' => 'bg-white text-black',
            'active'  => ['admin/periodos*', 'admin/grados*', 'admin/paralelos*'],
        ...
        [
            ...
            'classes' => 'bg-white text-black',
            'can' => 'admin.padres.index',
        ],
        [
            'text'    => 'Docentes',
            'icon'    => 'fas fa-user-tie',
            'classes' => 'bg-white text-black',
            'can' => 'admin.cursos-docentes.index',
            'submenu' => [
                [
                    'text' => 'Asignar Cursos',
        ...
        'DatatablesButtons' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/1.5.6/js/buttons.colVis.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
