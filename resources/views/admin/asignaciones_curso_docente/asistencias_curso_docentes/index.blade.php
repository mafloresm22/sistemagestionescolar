...
@section('title', 'Asistencia de Cursos')
...
<div class="d-flex justify-content-between align-items-center animate__animated animate__fadeIn">
    <div>
        ...
        <p class="text-muted mb-0">Selecciona un curso para registrar o gestionar las asistencias diarias.</p>
    </div>
</div>
@stop
                    ...
                    <tbody>
                        @foreach($asignaciones as $a)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="{{ route('admin.cursos-docentes-asistencias.create', $a->idAsignarCursoDocente) }}" 
                                       class="btn btn-primary-custom btn-sm px-3 shadow-sm hover-lift">
                                        <i class="fas fa-check-square mr-2"></i>Tomar Asistencia
                                    </a>
                                </td>
                            </tr>
                        @endforeach
